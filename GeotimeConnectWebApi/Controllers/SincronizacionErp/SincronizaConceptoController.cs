...
namespace GeoTimeConnectWebApi.Controllers.Procesos.Marcas
{
    ...
    [Route("[controller]")]
    [Authorize]
    public class SincronizaConceptoController : Controller
    {
        private readonly ISincronizaErp _repoGT;
        public SincronizaConceptoController(ISincronizaErp repoGT)
        {
            _repoGT = repoGT;
        }
        ...
        {
            EventResponse respuesta = await _repoGT.SincronizaConceptos();

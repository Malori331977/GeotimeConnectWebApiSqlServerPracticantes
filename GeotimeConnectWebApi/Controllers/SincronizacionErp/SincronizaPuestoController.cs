...
namespace GeoTimeConnectWebApi.Controllers.Procesos.Marcas
{
    ...
    [Route("[controller]")]
    [Authorize]
    public class SincronizaPuestoController : Controller
    {
        private readonly ISincronizaErp _repoGT;
        public SincronizaPuestoController(ISincronizaErp repoGT)
        {
            _repoGT = repoGT;
        }
        ...
        {
            EventResponse respuesta = await _repoGT.SincronizaPuestos();
